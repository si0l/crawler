...
@Slf4j
@Service("parseMakro")
public class ParseMakro implements Parse {
    ...
    public List<ItemDto> getItems(List<WebElement> elements, ProductDto productDto, String url, long date) {
        return elements.stream().map(element -> {
            ...
            try {
                priceElement = element.findElement(By.cssSelector("div>div div[dir=\"auto\"]"));
                labelElement = element.findElement(By.cssSelector("div>a>div"));
            ...
            ItemDto item = ItemDto.builder()
                    ...
                    .url(url)
                    .price(price)
                    .parsedPrice(PriceHelper.parsePrice(Source.MAKRO, price))
                    .isException(false)
                    .isFound(true)
